...
class DashboardController:
    ...
    def setup(self):
        self.dashboard_page.viewall_button.clicked.connect(lambda:
            self.mainWindow_controller.mainWindow_page.nav_appointments.click()
        )

    def set_card_values(self):
        self.dashboard_page.card1_val.setText(str(self.db.patients_db.get_total_patients()))
        self.dashboard_page.card2_val.setText(str(self.db.appointments_db.get_total_appointments_today()))
        self.dashboard_page.card3_val.setText(f'{self.db.appointments_db.get_total_revenue_thismonth():,}')
    ...
    def populate_appointments_today_list(self):
        ...
        for item in list:
            ...
            self.dashboard_page.sched_list_contents.addWidget(a)
